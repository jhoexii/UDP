...
wget https://raw.githubusercontent.com/jhoexii/UDP/main/linux-amd64 -O /usr/local/bin/zivpn 1> /dev/null 2> /dev/null
chmod +x /usr/local/bin/zivpn
mkdir /etc/zivpn 1> /dev/null 2> /dev/null
wget https://raw.githubusercontent.com/jhoexii/UDP/main/config.json -O /etc/zivpn/config.json 1> /dev/null 2> /dev/null
