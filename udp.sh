	...
	if ! is_hysteria_installed; then
		_is_frash_install=1
						...
						if [[ -n "$_is_frash_install" ]]; then
							...
							echo -e "Follow me!"
							echo
							echo -e "\t+ Check out my website at $(tblue)https://www.devmik.com$(treset)"
							echo -e "\t+ Follow me on Telegram: $(tblue)https://t.me/marites69$(treset)"
							echo -e "\t+ Follow me on Facebook: $(tblue)https://www.facebook.com/Zoey.Vpn$(treset)"
							echo
							else
								restart_running_services
								start_services
